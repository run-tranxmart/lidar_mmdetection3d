# The schedule is used by models trained on custom dataset
# The learning rate set in the cyclic schedule is the initial learning rate
# rather than the max learning rate. Since the target_ratio is (10, 1e-4),
# the learning rate will change from 0.00045 to 0.0045, than go to 0.0018*1e-4
lr = 0.00045
epoch_num = 80
pct_start=0.4

epoch_rise = epoch_num * pct_start
epoch_fall = epoch_num * (1-pct_start)
