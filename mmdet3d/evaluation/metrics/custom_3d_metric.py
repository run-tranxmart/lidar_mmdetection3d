...
from mmdet3d.evaluation import kitti_eval, custom_eval
...
class Custom3DMetric(BaseMetric):
    ...
    def __init__(
        ...
        super(Custom3DMetric, self).__init__(
    ...
    def custom_3d_evaluate(
        ...
        for name in results_dict:
            ...
            if name == "pred_instances" or metric == "img_bbox":
                ...
                #eval_types = ["bev", "3d"]
            ap_result_str, ap_dict_ = custom_eval(
