...
class KittiMetric(BaseMetric):
    ...
    def compute_metrics(self, results: List[dict]) -> Dict[str, float]:
        ...
        # for i in range(len(result_dict['pred_instances_3d'])):
        #     frame_dets = result_dict['pred_instances_3d'][i]
        #     if 'Pedestrian' in frame_dets['name']:
        #         import pdb; pdb.set_trace()
        #         frame_annos = gt_annos[i]

        # # Add to fix dimensions
        # for frame_annos in gt_annos:
        #     frame_annos['dimensions'][:, [0, 1, 2]] = frame_annos['dimensions'][:, [1, 2, 0]]
        # # print("annos: ", gt_annos[0])
        # # print("results: ", result_dict['pred_instances_3d'][0])
